...
var appendDir, archive, argv, asar, compatibilityMode, debug, doCompress, doOverwrite, done, entries, entry, err, examples, fs, generalError, help, input, inputPath, inputStat, line, metadata, minimist, os, output, path, pattern, pkg, prettyPrint, quiet, root, showExamples, showHelp, showList, showListSize, showVersion, usageError, useColors, verbose, verify, _i, _len;
