...
var archive, argv, asar, compatibilityMode, debug, doOverwrite, done, entries, entry, err, fs, generalError, help, input, inputStat, line, metadata, minimist, os, output, path, pkg, quiet, root, showHelp, showList, showListSize, showVersion, usageError, useColors, verbose, verify, _i, _len;
