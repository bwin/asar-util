...
var AsarArchive, crypto, fs, minimatch, mkdirp, os, path, queue, sortBy, stream, walkdir, zlib,
...
module.exports = AsarArchive = (function() {
  ...
  AsarArchive.prototype.addSymlink = function(filename, relativeTo, stat) {
    var linkAbsolute, linkTo, node, p, pAbsDir, pDir;
    if (stat == null) {
      stat = null;
    }
    p = path.relative(relativeTo, filename);
      ...
      return function(err, files) {
        ...
        for (_i = 0, _len = files.length; _i < _len; _i++) {
          ...
          if (file.stat.isDirectory()) {
            ...
            _this.addSymlink(file.name, relativeTo, file.stat);
          }
        }
